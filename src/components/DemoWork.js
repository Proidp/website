...
const DemoWork = () => {
    ...
    const getUsers = async () =>{
        const response = await fetch('https://raw.githubusercontent.com/Proidp/webdata/main/db.json');
                ...
                <div className="work__container container gird">
                        ...
                        {users.map((curElem) =>{
                            return(
                                ...
                                <div className="work__card mix web" key={curElem.id}>
                                <img src={curElem.image} alt="" className="work__img"/>

                                <h3 className="work__title">{curElem.name}</h3>
                                <p></p>
